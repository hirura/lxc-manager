...
class LxcManager
	class Network < ActiveRecord::Base
		...
		validates :vlan_id,    presence: true, uniqueness: { conditions: -> { where( deleted_at: nil ) } }, numericality: { only_integer: true, greater_than_or_equal_to: 1, less_than_or_equal_to: 4094 }
